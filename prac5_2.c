...
//  rtems_task_argument argument
//);
rtems_task TAvoidObstacles(rtems_task_argument);
rtems_task TPathTracking(rtems_task_argument);
rtems_task TSensorFusion(rtems_task_argument);
rtems_task TCalculatePath(rtems_task_argument);
...
rtems_task Init(rtems_task_argument argument)
{
  ...
  status = rtems_task_start( Task_id[ 3 ], TCalculatePath, 4 );
